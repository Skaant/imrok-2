export default {
  id: '12',
  title: "Réfléxions sur le financement de l'HIGHBS-BOK et les storyboards",
  date: '11/10/2020',
  tags: [ 'entrepreneuriat', 'highbs-bok.art', 'imrok.fr' ],
  description: "Cet article se destine aux artistes et aux entrepreneurs, et aborde deux notions importantes : on devient ce que l'on fait, et quelle valeur donner à notre production.",
  content: `Depuis que je suis re-passé *freelance* ([lien vers mon profil Malt](https://www.malt.fr/profile/romaricruga)),
...
le framework [kami.js](https://github.com/Skaant/kami.js) ?
Sur l'[HIGHBS-BOK](https://highbs-bok.art) ?
...
J'en parlais dans [un récent article sur Medium](https://medium.com/@OhmWang/is-raw-better-2f857279cb2c),
